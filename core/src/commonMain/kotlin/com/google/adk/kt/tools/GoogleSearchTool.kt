 ...
 * execution.
 */
class GoogleSearchTool(val bypassMultiToolsLimit: Boolean = false) :
  ...
  override suspend fun processLlmRequest(
    ...
    // Check if a Google Search tool is already present in the existing tools.
    val hasSearchTool = existingTools.any { it.googleSearch != null }
    if (hasSearchTool) {
      return llmRequest
    }
